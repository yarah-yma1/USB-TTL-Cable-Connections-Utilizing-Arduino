...
First step is to open up arduino ide. Create a new sketch and paste in the code found in the src folder named serialMonitorTest.ino afterwards open a new sketch and paste the same code. You should have two sketches up at the same time. One will be for the TTL and the other will be for USB cable. 
...
#### The image below shows the outputs/results of the following scripts. 
